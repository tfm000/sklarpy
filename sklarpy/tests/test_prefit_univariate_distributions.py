...
#
# def test_fit_to_data(discrete_univariate_data, continuous_univariate_data, univariate_dists_to_test):
#     """Testing we can fit distributions to data"""
#     # univariate_dists_to_test = ['normal', 'student_t', 'gamma']
#     # continuous_univariate_data = uniform_data
#     # discrete_univariate_data = poisson_data
#     for name in univariate_dists_to_test:
#         try:
#             if name in distributions_map['all continuous']:
#                 data: np.ndarray = continuous_univariate_data
#                 target_fit = FittedContinuousUnivariate
#             else:
#                 data: np.ndarray = discrete_univariate_data
...
#
#
# # def test_parametric_fit_to_params(discrete_univariate_data,
# #                                   continuous_univariate_data,
# #                                   univariate_dists_to_test):
# #     """Testing we can fit parametric distributions to user specified parameters
# #     """
# #     for name in univariate_dists_to_test:
# #         if name in distributions_map['all numerical']:
# #             continue
# #         elif name in distributions_map['all continuous parametric']:
# #             data: np.ndarray = continuous_univariate_data
# #             target_fit = FittedContinuousUnivariate
# #         else:
# #             data: np.ndarray = discrete_univariate_data
