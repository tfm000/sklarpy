...
from sklarpy.univariate.distributions import alpha, anglit, arcsine, argus, beta, betaprime, bradford, burr, burr12, \
    ...
    geninvgauss, genlogistic, gennorm, genpareto, gilbrat, gompertz, gumbel_l, gumbel_r, halfcauchy, \
    halfgennorm, halflogistic, halfnorm, hypsecant, invgamma, invgauss, invweibull, johnsonsb, johnsonsu, kappa3, \
    ...
    semicircular, skewcauchy, skewnorm, t, trapezoid, trapz, triang, truncexpon, truncnorm, tukeylambda, uniform, \
