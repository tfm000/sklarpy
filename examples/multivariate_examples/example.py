# This file contains examples of how to use multivariate distributions in SklarPy.
# Here we use the multivariate normal and multivariate symmetric hyperbolic distributions, though all methods / attributes are generalized.
import numpy as np
import pandas as pd
...
# fitting a symmetric hyperbolic dist to our generated data
from sklarpy.multivariate import multivariate_sym_hyperbolic

fitted_msh = multivariate_sym_hyperbolic.fit(rvs_df, show_progress=True)
...
# we can then easily load these parameters and use them to fit another distribution
